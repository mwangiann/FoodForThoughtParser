...
class TestParser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.orders_list = json.loads(orders_json)
    ...
    def test_should_check_the_order_with_most_items(self):
        self.assertEqual(self.biggest_order(),3)

    def biggest_order(self):
        max_value = 0
        for order_hash in self.orders_list:
